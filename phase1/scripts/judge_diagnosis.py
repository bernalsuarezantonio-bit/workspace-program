# Copyright 2026 — Phase 1 delegate. Stage P1: gemma2:27b diagnosis judge (Ollama).
...
def main() -> int:
    ...
    tmpl = judge_template()
    readouts = REPO / "phase1" / "data" / ("readouts_smoke" if args.smoke else "readouts")
    run_manifest = REPO / "phase1" / "data" / f"run_manifest_{tag}.jsonl"
    out_path = REPO / "phase1" / "data" / f"judge_{tag}.jsonl"
    ...
    with out_path.open("a", encoding="utf-8") as out:
        for i, r in enumerate(todo, 1):
            ...
            rec = {"trial_id": r["trial_id"], "cell": r["cell"], "disorder": r["disorder"],
