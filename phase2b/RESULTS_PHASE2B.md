...
| check | value | status |
|---|---|---|
| tag `prereg-phase2b-v1` → tag object | `7ac0093bce4b6cef…` | ✓ |
| tag → commit | `aa77d66c57aec63b…` | ✓ |
| tagger | `Antonio Bernal <bernalsuarezantonio@gmail.com>` | ✓ |
| `PREREG_PHASE2B.md` blob sha256 @ `aa77d66` | `f17ac3656177db8a35586201addfc6c3d29d470d66897f397ebb4ab97a3dd8c5` | ✓ |
| data commit `317ddb9` descends from the tag | `git merge-base --is-ancestor aa77d66 317ddb9` → true; path `8bf3c3d → 29bafc0 → 317ddb9` | ✓ |
...
*Generated by `phase2b/scripts/analyze_phase2b.py` and `landing_check_2b.py` against data commit `317ddb9` (digest `aa56df8d…`), under `prereg-phase2b-v1` → `aa77d66`. This report is committed at the hash recorded in the line below. Interpretation is the PI's (R5 asymmetric-informativeness clause governs the §6 readout).*
...
**Report content first committed at:** `6eb01d443ffd05221e5e675ab06f5f55f005e9ef`
