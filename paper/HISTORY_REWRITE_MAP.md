# History rewrite — old-to-new hash correspondence
...
| tag | old tag-obj | new tag-obj |
|---|---|---|
| `prereg-phase1-v1` | `95eddc5` | `3f74752` |
| `prereg-phase2-v1` | `f058631` | `b58d0c7` |
| `prereg-phase2b-v1` | `54efcfa` | `7ac0093` |

Seal-chain content hashes are unchanged (3689ac85 / 9530aceb / cfce4742); data-content digests are unchanged (dc522361 Phase 1; aa56df8d Phase 2b); prereg blob sha256 unchanged (bedbcc78 Phase 1; f17ac365 Phase 2b).
